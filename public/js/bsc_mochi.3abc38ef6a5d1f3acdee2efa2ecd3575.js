...
async function main() {  
   ...
   const MOCHI_CHEF_ADDR = "0xA9C9D9Aed47320835c84090c62dC324FcF24f683";
   const rewardTokenTicker = "MOCHI";
   const MOCHI_CHEF = new ethers.Contract(MOCHI_CHEF_ADDR, MOCHI_CHEF_ABI, App.provider);

   const rewardsPerWeek = await MOCHI_CHEF.mochiPerBlock() /1e18
        * 604800 / 3;

    const tokens = {};
    const prices = await getBscPrices();

    await loadBscChefContract(App, tokens, prices, MOCHI_CHEF, MOCHI_CHEF_ADDR, MOCHI_CHEF_ABI, rewardTokenTicker,
        "mochi", null, rewardsPerWeek, "pendingMochi");
