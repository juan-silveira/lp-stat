...
async function main() {  
   ...
   const RA_CHEF_ADDR = "0x0E12312eF15F033b75eF24e3Db89E375215C61cc";
   const rewardTokenTicker = "RA";
   const RA_CHEF = new ethers.Contract(RA_CHEF_ADDR, RA_CHEF_ABI, App.provider);

   const rewardsPerWeek = await RA_CHEF.vikingPerBlock() /1e18
        * 604800 / 3;

    const tokens = {};
    const prices = await getBscPrices();

    await loadBscChefContract(App, tokens, prices, RA_CHEF, RA_CHEF_ADDR, RA_CHEF_ABI, rewardTokenTicker,
