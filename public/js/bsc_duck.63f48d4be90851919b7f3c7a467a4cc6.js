...
async function main() {  
   ...
   const DUCK_CHEF_ADDR = "0xE7C180E18867fBdB6267C50e4091EB2140d68f6E";
   const rewardTokenTicker = "DUCK";
   const DUCK_CHEF = new ethers.Contract(DUCK_CHEF_ADDR, DUCK_CHEF_ABI, App.provider);

   const rewardsPerWeek = await DUCK_CHEF.eggPerBlock() /1e18
        * 604800 / 3;

    const tokens = {};
    const prices = await getBscPrices();

    await loadBscChefContract(App, tokens, prices, DUCK_CHEF, DUCK_CHEF_ADDR, DUCK_CHEF_ABI, rewardTokenTicker,
