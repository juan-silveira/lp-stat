...
async function main() {  
   ...
   const VIKING_CHEF_ADDR = "0xEf6e807fD2c0Ef5883A03Ed1b962333E8C9b725f";
   const rewardTokenTicker = "VIKING";
   const VIKING_CHEF = new ethers.Contract(VIKING_CHEF_ADDR, VIKING_CHEF_ABI, App.provider);

   const rewardsPerWeek = await VIKING_CHEF.vikingPerBlock() /1e18
        * 604800 / 3;

    const tokens = {};
    const prices = await getBscPrices();

    await loadBscChefContract(App, tokens, prices, VIKING_CHEF, VIKING_CHEF_ADDR, VIKING_CHEF_ABI, rewardTokenTicker,
